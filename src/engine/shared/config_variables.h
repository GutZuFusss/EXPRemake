...
MACRO_CONFIG_INT(SvMaxClients, sv_max_clients, 6, 6, 6, CFGFLAG_SERVER, "Maximum number of clients that are allowed on a server")
...
MACRO_CONFIG_INT(SvAllowUTF8Names, sv_allow_utf8_names, 1, 0, 1, CFGFLAG_SERVER, "Allow UTF-8 in client names")

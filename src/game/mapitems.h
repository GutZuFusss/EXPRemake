...
enum
{
	...
	ENTITY_SPAWN_BOT_HAMMER = 40,
	ENTITY_SPAWN_BOT_PISTOL = 41,
	ENTITY_SPAWN_BOT_NINJA = 42,
	ENTITY_SPAWN_BOT_KAMIKAZE = 43,
	ENTITY_SPAWN_BOT_SHOTGUN = 44,

	ENTITY_SPAWN_BOT_GRENADE = 56,
	ENTITY_SPAWN_BOT_LASER = 57,
	ENTITY_SPAWN_BOT_THOR = 58,
	ENTITY_SPAWN_BOT_FLAGBEARER = 59,
	ENTITY_SPAWN_BOT_ENDBOSS = 60,
